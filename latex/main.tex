...
A seção de metodologia será responsável por apresentar o caminho lógico que resultou na criação da Jataí. Serão apresentadas as etapas de pesquisa exploratória, que será utilizada para mapear o Open Finance, compreender os problemas enfrentados por estudantes e desenvolvedores iniciantes e orientar a formulação da Jataí; de pesquisa documental, responsável por fundamentar, por meio de documentos legais e técnicos, a constituição da empresa júnior; de levantamento de requisitos, que busca definir o que a empresa deve possuir para agregar valor diante do problema apresentado; de prototipagem, que apresenta um conjunto de protótipos desenvolvidos com base nos requisitos levantados; e de validação com os usuários, que busca verificar se a entrega de valor está de acordo com as expectativas do público-alvo.

% pesquisa exploratoria

O Open Finance é um sistema de integração financeira naturalmente complexo, que consegue, com maestria, integrar todo o \sfn{} brasileiro. Atualmente existem materiais oficiais disponibilizados de forma pública, com um viés extremamente teórico, justificado pelo público-alvo desses produtos, composto por desenvolvedores que prestam serviço em instituições financeiras. Estudantes não devem se prender apenas ao aspecto teórico disponibilizado nas documentações oficiais, também devem praticar o conteúdo lido, esse é o nicho identificado pela Jataí.
